    ...
    selectButton(index) {
      ...
      switch (index) {
        case 0:
          ...
          break;
        case 1:
          this.currentComponent = 'TeachersComponent';
          break;
        case 2:
          this.currentComponent = 'TeacherSubjectsComponent';
          break;
        case 3:
          this.currentComponent = 'TimeSubjectsComponent';
          break;
        case 4:
