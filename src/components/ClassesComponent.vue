<!-- src/components/ClassesComponent.vue -->
<template>
  <div>
    <main>
      <div class="source-container">
        <input
          ...
          placeholder="Добавить Класс/Группу"
          class="source-add"
  ...
  methods: {
    addGroup() {
      if (this.newGroupName.trim()) {
        useGroupsStore().addGroup(this.newGroupName);
        this.newGroupName = '';
      }
    },
    startEdit(group) {
    ...
    updateGroup() {
      if (this.editingGroup && this.newGroupName.trim()) {
        useGroupsStore().updateGroup(this.editingGroup.id, this.newGroupName);
        this.editingGroup = null;
        this.newGroupName = '';
      }
    },
    deleteGroup(id) {
      useGroupsStore().deleteGroup(id);
    },
  },
  mounted() {
